...
// The program uses linked lists to add, print, and delete from a student database
...
{   
    ...
    while (playing) {
        ...
        // if user wants ot quit, loops ends :(
            ...
            cout << "The average GPA's of all the students is: " << fixed << setprecision(2) << average(head) << endl;
        }
